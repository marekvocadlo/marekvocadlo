...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="group rounded-full bg-white/90 px-3 py-2 shadow-lg shadow-blue-800/5 ring-1 ring-blue-900/5 backdrop-blur transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20"
      onClick={() => setTheme(otherTheme)}
    >
      <SunIcon className="h-6 w-6 fill-blue-100 stroke-blue-500 transition group-hover:fill-zinc-200 group-hover:stroke-blue-700 dark:hidden [@media(prefers-color-scheme:dark)]:fill-teal-50 [@media(prefers-color-scheme:dark)]:stroke-blue-500 [@media(prefers-color-scheme:dark)]:group-hover:fill-teal-50 [@media(prefers-color-scheme:dark)]:group-hover:stroke-blue-600" />
