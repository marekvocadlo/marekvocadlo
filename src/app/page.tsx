...
import logoAbc from '@/images/logos/abc.png'
import logoVse from '@/images/logos/vse.png'
import logoCvut from '@/images/logos/cvut.jpg'
import me from '@/images/photos/portrait.jpeg'
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Vzdělání</span>
      </h2>
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'ABC Českého Hospodářství a.s.',
      title: 'Správce databáze',
      logo: logoAbc,
      start: '2013',
      end: '2017',
    },
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        <BriefcaseIcon className="h-6 w-6 flex-none" />
        <span className="ml-3">Pracovní zkušenosti</span>
      </h2>
      <ol className="mt-6 space-y-4">
      ...
      <Container className="mt-9">
        <div className="max-w-full">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://www.linkedin.com/in/marek-vocadlo/"
              aria-label="Follow on LinkedIn"
              icon={LinkedInIcon}
            />
            <SocialLink
              href="https://github.com/marekvocadlo"
